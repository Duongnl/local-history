...
const ContentPage1 = () => {
    return (
        <>
            <div className="w-full mt-[60px] flex  flex-grow contentpage1">
                <motion.div
                    ...
                    className="basis-4/6 flex max-[797px]:basis-3/6  justify-center items-center"
                >
                ...
                <motion.div
                    ...
                    className=" bg-wihte basis-2/6 max-[797px]:basis-3/6 image-map"
                >
                    <img
                        src="map.jpg"
                        alt="map"
